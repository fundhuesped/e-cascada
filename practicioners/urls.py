...
urlpatterns = [
    ...
    url(r'^practicioner-role/$', views.PracticionerRoleList.as_view(), name='PracticionerRole-list'),
    url(r'^practicioner-role/(?P<pk>[0-9]+)/$', views.PracticionerRoleDetails.as_view(),name='PracticionerRole-detail'),
    url(r'^practicioner-role-period/$', views.PracticionerRolePeriodList.as_view(), name='PracticionerRolePeriod-list'),
    url(r'^practicioner-role-period/(?P<pk>[0-9]+)/$', views.PracticionerRolePeriodDetails.as_view(),name='PracticionerRolePeriod-detail'),
    url(r'^practicioner-qualification-period/$', views.PracticionerQualificationPeriodList.as_view(), name='PracticionerQualificationPeriod-list'),
    url(r'^practicioner-qualification-period/(?P<pk>[0-9]+)/$', views.PracticionerQualificationPeriodDetails.as_view(),name='PracticionerQualificationPeriod-detail'),
    ...
    url(r'^role/$', views.RoleList.as_view(), name='Role-list'),
    url(r'^role/(?P<pk>[0-9]+)/$', views.RoleDetails.as_view(),name='Role-detail'),
