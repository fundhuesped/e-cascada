...
__author__ = 'Santi'
#Clase ContactPoint
#Segn FHIR> Details for all kinds of technology-mediated contact points for a person or organization, including telephone, email, etc.
#Mas informacin: https://www.hl7.org/fhir/datatypes.html#ContactPoint
