...
# Creado siguiendo estandar FHIR. Mas informacin en : https://www.hl7.org/fhir/datatypes.html#Identifier
class Identifier(models.Model):
    ...
    assigner = models.TextField(null=True)                                                  #Organizacin que gener el ID (segn HL7 puede ser solo texto para evitar dependencia cruzada)
