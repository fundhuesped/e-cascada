...
urlpatterns = [
    ...
    url(r'^meta-profesional/$', views.ProfesionalMetaList.as_view(), name='ProfesionalMeta-list'),
    url(r'^meta-profesional/(?P<pk>[0-9]+)/$', views.ProfesionalMetaDetails.as_view(),name='ProfesionalMeta-detail'),
