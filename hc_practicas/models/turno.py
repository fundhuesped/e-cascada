...
class Turno(ActiveModel):
    ...
    turnoSlot = models.ForeignKey(TurnoSlot, null=False, related_name='turnos', on_delete=models.SET_NULL)
    notes = models.CharField(blank=True, max_length=150, null=True)
    createdBy = models.ForeignKey(User, null=True, blank=True, related_name='createdBy', on_delete=models.SET_NULL)
    lastModifiedBy = models.ForeignKey(User, null=True, blank=True, related_name='lastModifiedBy', on_delete=models.SET_NULL)
