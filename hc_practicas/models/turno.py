...
class Turno(ActiveModel):
    ...
    createdBy = models.ForeignKey(User, null=True, blank=True, related_name='createdBy')
    lastModifiedBy = models.ForeignKey(User, null=True, blank=True, related_name='lastModifiedBy')
